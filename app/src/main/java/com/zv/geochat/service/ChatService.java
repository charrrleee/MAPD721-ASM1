...
public class ChatService extends Service {
    ...
    public static final int CMD_ERROR_93 = 93;
    ...
    public static final String KEY_STUDENT_ID = "93";
    ...
    private void handleData(Bundle data) {
        ...
        } else if(command == CMD_ERROR_93) {
            notificationDecorator.displaySimpleNotification("Connect Error: "+ KEY_STUDENT_ID, "");
        } else if(command == CMD_SEND_RANDOM_ID) {
            String randStudentId = (String) data.get(KEY_STUDENT_ID);
            notificationDecorator.displaySimpleNotification("ChatService Received: " + randStudentId, "");
        } else {
